...
MODEL_PATH = "yolov8m.pt"   # try m first; if too slow, use n or s
TRACKER_CFG = "bytetrack.yaml"

# COCO vehicle classes
TARGET_CLASSES = {2, 3, 5, 7}  # car, motorcycle, bus, truck

# Count lines from your current project
COUNT_LINES = {
...
OUTPUT_VIDEO = "bytetrack_output.mp4"
OUTPUT_LOG = "bytetrack_events.csv"
...
def motion_score(dx, dy, direction):
    ...
    return ux * tx + uy * ty  # cosine similarity
...
def main():
    ...
    with open(OUTPUT_LOG, "w", newline="") as f:
        ...
        frame_idx = 0
        cv2.namedWindow("ByteTrack Test", cv2.WINDOW_NORMAL)
        ...
        while True:
            ...
            if result.boxes is not None:
                for box in result.boxes:
                    ...
                    # smoothed motion across history
                    ...
                    if candidates:
                        # prioritize best motion alignment, then closest line
